...
|<sub> +enable \<módulo\> [abrangência] |<sub>Habilita um módulo no canal ou server <br> Os módulos são: Ruby, Level, NSFW, Games|<sub>`+enable ruby s` <br> Ativa Rubys no Server <br>`+enable nsfw c`  <br>Ativa NSFW no Canal|<sub> :heavy_check_mark:|<sub>
